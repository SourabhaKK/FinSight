...
\caption{Figure 1: Confusion matrices for TF-IDF + Logistic Regression (left) and DistilBERT (right) on HuffPost News Category Dataset test samples (Misra, 2022). DistilBERT shows notably fewer cross-class confusions.}
\label{fig:confusion}
\end{figure}
